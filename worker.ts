/**
 * Its-Broken Triage Worker
 *
 * This is the LLM agent that does the actual triage work.
 * It is called by the router agent after channel validation.
 */
import {
  gitHubTools,
  guildTools,
...
export default llmAgent({
  identifier: "its-broken-triage-worker",
  description:
    "Performs the actual bug triage work. Reads Slack thread, searches code, " +
    "creates GitHub issue, and replies in Slack. Called by the router after " +
    "channel validation.",
  tools,
  systemPrompt,
  mode: "multi-turn",
